...
import { AlertCircle, CheckCircle2, ShieldAlert, Send, Camera, Terminal, Eye, Lock, Mic, Globe2, Volume2 } from 'lucide-react';
import PrivacyShieldCCTV from './PrivacyShieldCCTV';
import MultilingualCommandBar from './MultilingualCommandBar';
import { fetchAlerts, acknowledgeAlertOnBackend } from '../utils/api';
...
export default function RightAlertPanel({ 
  ...
  const [activeTab, setActiveTab] = useState('alerts'); // 'alerts' | 'cctv' | 'voice'
  ...
  const handleAcknowledge = async (id) => {
    ...
    await acknowledgeAlertOnBackend(id);
  };
